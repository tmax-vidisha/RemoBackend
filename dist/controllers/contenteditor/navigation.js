...
exports.postRemoNavigation = void 0;
...
const postRemoNavigation = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token) {
        ...
        try {
            const response = yield (0, node_fetch_1.default)(`${BASE_PATH}/${Site_Id}/lists/${Navigation_Id}/items`, {
                method: 'POST',
                headers: {
...
exports.postRemoNavigation = postRemoNavigation;
