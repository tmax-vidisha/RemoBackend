...
const postCeo = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token) {
        ...
        try {
            const response = yield (0, node_fetch_1.default)(`https://graph.microsoft.com/v1.0/sites/tmxin.sharepoint.com,39018770-3534-4cef-a057-785c43b6a200,47c126a5-33ee-420a-a84a-c8430a368a43/lists/17897d96-e2f4-4e34-a48e-a312836fca40/items`, {
                method: 'POST',
                headers: {
