...
const postRemoEvents = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { 
    // token,
    title, description, image, imageName, location, category, startDate, endDate, isDraft
    ...
    if (!token) {
        ...
        try {
            const response = yield (0, node_fetch_1.default)(`${BASE_PATH}/${Site_Id}/lists/${Events_Id}/items`, {
                method: 'POST',
                headers: {
...
exports.postRemoEvents = postRemoEvents;
